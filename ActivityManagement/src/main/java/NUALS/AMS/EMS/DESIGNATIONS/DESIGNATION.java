package NUALS.AMS.EMS.DESIGNATIONS;
...
public class DESIGNATION
{
	...
	@Column(name = "design_shortform", nullable = false, length=30, unique=true)
	@NotBlank(message = "Shortform must not be blank")
	private String design_shortform;
	
	@Column(name = "design_fullform", nullable = false,length=100,unique=true)
	@NotBlank(message = "Full must not be blank")
	private String  design_fullform;
	...
	@Column(name = "designstatus", nullable = false,columnDefinition = "varchar(20) default 'submitted'")
	...
	public DESIGNATION(String design_id)
	{
		this.design_id = Integer.parseInt(design_id);
	}

	public DESIGNATION(int design_id, @NotBlank(message = "Shortform must not be blank") String design_shortform,
			@NotBlank(message = "Full must not be blank") String design_fullform, String description, String maker,
			String level1Checker, Date level1CheckDate, String level1Remarks, String level2Checker,
			Date level2CheckDate, String level2Remarks, String approvedBy, Date approvedDate, String approvedRemarks,
			String updateBy, String updateRemarks, int rowid, String designstatus, LocalDateTime createDateTime,
			LocalDateTime updateDateTime) {
		this.design_id = design_id;
		this.design_shortform = design_shortform;
		this.design_fullform = design_fullform;
	...
	public String getDesign_shortform() {
		return design_shortform;
	}

	public void setDesign_shortform(String design_shortform) {
		this.design_shortform = design_shortform;
	}

	public String getDesign_fullform() {
		return design_fullform;
	}

	public void setDesign_fullform(String design_fullform) {
		this.design_fullform = design_fullform;
	}
	...
	public String toString() {
		return "DESIGNATION [design_id=" + design_id + ", design_shortform=" + design_shortform + ", design_fullform="
				+ design_fullform + ", description=" + description + ", maker=" + maker + ", level1Checker="
				...
				+ ", designstatus=" + designstatus + ", createDateTime=" + createDateTime + ", updateDateTime="
				+ updateDateTime + "]";
	}
