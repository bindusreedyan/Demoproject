...
/* 	$.ajax({
	...
	$.ajax({
		...
		success:function(data)
		{
			...
			console.log("userCode array"+userCodeArray.toString());
			$.ajax({
				"url" : "/academicactivity/getStudentPersonalDetails",
				"method" : "GET",
				data:{"userCodeArray":userCodeArray.toString(),"participationId":particiaptionRequestId},
...
function loadParticipantRequestApproval() {
	...
	$.ajax({
		"url" : "/academicactivity/getAllParticipantRequestFinalApprovedByParticipantForFacultyRecom",
		"method" : "GET",
		success : function(data) {
				...
				if(selectedRowFromDataTable != null)
				{
					...
					$.ajax({
						...
						success:function(data)
						{
							...
							console.log(userCodeArray.toString());
							var usercodeArraystring=userCodeArray.toString();
							
							//console.log("userCodeArray.toString()"+userCodeArray.toString());
							$.ajax({
								"url" : "/academicactivity/getStudentPersonalDetails",
								"method" : "GET",
								data:{"userCodeArray":usercodeArraystring,"participationId":particiaptionRequestId},
...
$(document).ready(function() {
	        				...
	        				$.ajax({
	        					...
	        					"method" : "POST",
	        					 ...
	        					 success : function(data)
	        					 {
	        						if(data)
	        							{
	        							showMessage("Other Expenses are successfully verified");
	        							}
	        						else
	        							{
	...
	$('#AccomadationDetails').unbind().bind('submit',function(event) 
			   {
			   			...
			   			//	$('#confId').unbind().bind('click',function(){
			   	            formData.push({"name":"participateRequestId","value":participateRequestId});
			   	            formData.push({"name":"activityCode","value":activityId});
			   	            formData.push({"name":"status","value":"raised"});
	...
	$('#remarksForm').unbind().bind('submit',function(event) {
	        event.preventDefault();      
	        var remarks=$("#settleRecomRemarkId").val();
			...
			$('#confId').unbind().bind('click',function(){
				console.log("confirm clicked...");
				$.ajax({
					"url" : "/academicactivity/addSettlementFacultyRecom",
					"method" : "GET",
...
<div class="card-body">
   	<div class="table-responsive">
			<table otherClaimedIdclass="table table-bordered table-hover dataTable dtr-inline collapsed table-sm cell-border" id="participantActivityTable">
...
<div class="card-header">
   <h3>Faculty Recommendation of Program Participation Settlement </h3>
</div>
<div class="card-body">
<div class="row">
...
<button type="submit" id="activityPaticipationMastersubmit" class="btn btn-primary">Seen And Verify</button>
 ...
 <div id="otherExpenseId">
  ...
  <tbody>
      ...
      <td><input type="text" name="regFeeSpent2" id="regFeeSpentId2" disabled="disabled"/></td>
	   ...
	   <div class="row">
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
               ...
               <textarea id="settleRecomRemarkId" name="settleRecomRemark" rows="4" cols="50"
                  class="form-control"></textarea>
            </div>
		...
		<div class="col-6">
		 	...
		 	<div class="form-group">
		   	...
		   	<div class="form-group">
		   		...
		   		<input type="number" class="form-control" id="amntClaimedId"  name="amntClaimed">
		   	</div>
		</div>
		</div> 
		<div class="modal-footer">
