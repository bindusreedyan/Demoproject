...
$("#otherExpensesId" ).on('click',function(event) {
   ...
   function loadAllparticipationRequestFinallyApprovedBy() {
		$.ajax({
			"url" : "/academicactivity/getAllParticipantFinallyApprovedByForEdit",
			"method" : "GET",
				...
				if(selectedRowFromDataTable != null)
				{
					...
					$.ajax({
									...
									success : function(data) 
									{
		                                ...
		                                $('#finalStatusId').val(data['participationRequestStatus']);
										$('#finalApprovedRemarkId').val(data['approvedRemark']);										
...
<div class="card-header">
   <h3>Edit For Final Approval Participation Request</h3>
</div>
<div class="card-body">
<div class="row">
