...
function loadParticipantRequestApproval() {
	...
	$.ajax({
		"url" : "/academicactivity/getAllParticipantSettlementForFinalApproved",
		"method" : "GET",
		success : function(data) {
...
$(document).ready(function() {
	...
	$('#remarksForm').unbind().bind('submit',function(event) {
	        event.preventDefault();      
	        var remarks=$("#settleFinalRemarkId").val();
			...
			$('#confId').unbind().bind('click',function(){
				console.log("confirm clicked...");
				$.ajax({
					"url" : "/academicactivity/addSettlementFinalRecom",
					"method" : "GET",
...
<div class="card-header">
   <h3>Final Approval of Program Participation Settlement </h3>
</div>
<div class="card-body">
<div class="row">
	   ...
	   <div class="row">
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           ...
           <div class="form-group">
               ...
               <div style="width: 100%">
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="settlementStatus"
                        ...
                        <option value="se">Select</option>
                        <option value="Finally Approved">Recommend</option>
                        <option value="Finally Rejected">Reject</option>
             ...
             <div class="form-group">
               <label for="remarks"> Final Approval Remark</label>
               <textarea id="settleFinalRemarkId" name="settleFinalRemark" rows="4" cols="50"
                  class="form-control"></textarea>
            </div>
