   		...
   		$('#otherExpenseForm').unbind().bind('submit',function(event) {
	                   ...
	                   // formData.push({"name":"totalExpenseProgram","value":estim});
	        			...
	        			$('#confId').unbind().bind('click',function(){
	        				console.log("confirm clicked...");
	        				$.ajax({
	        					"url" : "/academicactivity/ActivityParticipantOtherExpensesEdit",
	        					"method" : "POST",
	        					 data : formData,
	        					 success : function(data)
	        					 {
			...
			$('#otherDetailsForm').unbind().bind('submit',function(event) {
	   			console.log("other expenses form");
		        			...
		        			$('#confId').unbind().bind('click',function(){
		        				console.log("confirm clicked...");
		        				$.ajax({
		        					"url" : "/academicactivity/editActivityParticipantOtherDetails",
		        					"method" : "POST",
		        					 data : formData,
		        					 success : function(data)
		        					 {
	...
	$('#bankDetailsForm').unbind().bind('submit',function(event) {
			console.log("other expenses form");
        			...
        			$('#confId').unbind().bind('click',function(){
        				console.log("confirm clicked...");
        				$.ajax({
        					"url" : "/academicactivity/ActivityBankDetailsEdit",
        					"method" : "POST",
        					 data : formData,
        					 success : function(data)
        					 {
