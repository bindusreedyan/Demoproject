...
function loadParticipantRequestApproval() {
	...
	$.ajax({
		"url" : "/academicactivity/getAllParticipantRequestFinalApprovedByParticipant",
		"method" : "GET",
		success : function(data) {
	   					...
	   					$.ajax({
	   						...
	   						"method" : "POST",
	   						 ...
	   						 success : function(data) {
	   							...
	   							showMessage("Parcipation Settlement Master Data is successfully added"+particiaptionRequestId);
	   							loadParticipantRequestApproval();
...
// 	 		});
	...
	$('#remarksForm').unbind().bind('submit',function(event) {
	        event.preventDefault();      
	        var remarks=$("#settlementUserRemarkId").val();
	       var status="raised";
	        $('#submitModel').modal('show');
			$('#confId').unbind().bind('click',function(){
				console.log("confirm clicked...");
				$.ajax({
					"url" : "/academicactivity/addSettlementRemaks",
					"method" : "GET",
...
<div  id="gridRow" class="card card-info card-outline">
	<div class="card-header">
	  <h3>List Of Participation Request</h3>
...
<div class="card-header">
   <h3>Participation Settlement Request</h3>
</div>
<div class="card-body">
<div class="row">
		    ...
		    <div class="form-group">
		   	...
		   	<div class="form-group">
		   		<label for="Expenditure">Amount Claimed</label> <input type="text" class="form-control" id="onwardAmountClaimedId"
							name="onwardAmountClaimed" value="0">
					</div>
		...
		<form id="returnJourneyDetails" >
		    ...
		    <div class="form-group">
		   	...
		   	<div class="form-group">
		   		...
		   		<input type="number" class="form-control" id="returnAmntClaimedId"  name="returnAmntClaimed" value="0">
		   	</div>
		 	...
		 	<div class="form-group">
		   	...
		   	<div class="form-group">
		    	...
		    	<div class="form-group">
		   		...
		   		<input type="text" class="form-control " id="billNoId"  name="billNo">
		   	</div>
