	        ...
	        sum2=sum2+parseFloat(amnt66 ); 
		   		...
		   		$.ajax({
					...
					success:function(data)
					{
						...
						for(var i=0;i<data.length;i++)
							{
							onWardJourneyAmountAdmit=onWardJourneyAmountAdmit+data[i]['onward_amount_admitted'];
							returnJourneyAmountAdmit=returnJourneyAmountAdmit+data[i]['return_amount_admitted'];
							accomAmountAdmit=accomAmountAdmit+data[i]['amount_admitted'];
							}
...
function loadAllparticipationRequestFinancialApprovedBy() {
	$.ajax({
		"url" : "/academicactivity/getAllParticipantFinanciallyApprovedBy",
		"method" : "GET",
		success : function(data) {
...
function loadParticipantRequestApproval() {
	...
	$.ajax({
		"url" : "/academicactivity/getAllParticipantFinancialApprovedByStatus",
		"method" : "GET",
		success : function(data) {
				...
				if(selectedRowFromDataTable != null)
				{
					...
					$.ajax({
									...
									success : function(data) 
									{
										...
										$('#financialStatusId').val(data['participationRequestStatus']);
										
										$('#financialApproveRemarksId').val(data['financialApproveRemarks']);
...
$(document).ready(function() {
	...
	loadAllparticipationRequestFinancialApprovedBy();
	$.ajax({
...
<div class="card-header">
   <h3>Finance Approval for Participation Request</h3>
</div>
<div class="card-body">
<div class="row">
...
<div id="tabs">
	...
	<li style="background-color:#3d5e48;text-color:white;"><a href="#tabs-3" style="color:#d5e6e4">Other Expenses</a></li>
  	...
  	<li style="background-color:#d92176;text-color:white;"><a href="#tabs-5" style="color:#d5e6e4">Financial Approval</a></li>
	  </ul>
	  <div id="tabs-1">
  ...
  <tbody>
   ...
   <!--  <tr>
     ...
     <tr>
      ...
      <td><b></b></td>
      <td></td>
      <td><input type="button" value="getTotal of Admitted Amount"  id="otherExpensesId"/></td>
      </tr>
     <tr>
      <th scope="row"></th>
	   ...
	   <div class="row">
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
               ...
               <div style="width: 100%">
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="financialStatus"
                        id="financialStatusId" required>
                        <option value="se">Select</option>
            ...
            <div class="form-group">
               <label for="remarks"> Financial Sanction Amount</label>
             ...
             <div class="form-group">
               ...
               <textarea id="financialApproveRemarksId" name="financialApproveRemarks" rows="4" cols="50"
                  class="form-control"></textarea>
            </div>
           <!--  <div class="form-group">
...
<div  id="gridRow" class="card card-info card-outline">
  	...
  	<div class="card-header">
		  <h3 >List Of Participation Request Financially Verified</h3>
...
<div class="modal-body">
		<form id="returnJourneyDetails" >
		    ...
		    <div class="form-group">
		   	...
		   	<div class="form-group">
		   		<label for="Expenditure">Estimated Expenditure</label>
		   		<input type="number" class="form-control" id="returnEstExpenditureId"  name="returnEstimExp">
		   	</div>
		   	<div class="form-group">
		   		<label for="Expenditure">Admitted Expenditure</label>
		   		<input type="number" class="form-control" id="returnAmntAdmtId"  name="returnAmntAdmt">
		   	</div>
