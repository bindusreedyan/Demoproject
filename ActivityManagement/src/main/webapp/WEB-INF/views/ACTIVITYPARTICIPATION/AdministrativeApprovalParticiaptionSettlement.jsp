...
function loadParticipantRequestApproval() {
	...
	$.ajax({
		"url" : "/academicactivity/getAllParticipantSettlementForAdministrativeApproved",
		"method" : "GET",
		success : function(data) {
				...
				if(selectedRowFromDataTable != null)
				{
					...
					$.ajax({
									...
									success : function(data) 
									{
										...
										$('#settleRecomRemarkId').val(data['recomRemarks']);
					...
					$.ajax({
						...
						success:function(data)
						{
							...
							console.log("usercodearray to String"+userCodeArray.toString());
...
$(document).ready(function() {
	...
	$('#remarksForm').unbind().bind('submit',function(event) {
	        event.preventDefault();      
	        var remarks=$("#adminApprovalRemarkId").val();
			...
			$('#confId').unbind().bind('click',function(){
				console.log("confirm clicked...");
				$.ajax({
					"url" : "/academicactivity/addSettlementAdministrativeRecom",
					"method" : "GET",
...
<div class="card-header">
   <h3>Administrative Approval of Program Participation Settlement </h3>
</div>
<div class="card-body">
<div class="row">
	   ...
	   <div class="row">
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group" class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
               ...
               <div style="width: 100%">
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="settlementStatus"
                        ...
                        <option value="se">Select</option>
                        <option value="Administrative Approved">Recommend</option>
                        <option value="Administrative Rejected">Reject</option>
             ...
             <div class="form-group">
               <label for="remarks"> Administrative Approval Remark</label>
