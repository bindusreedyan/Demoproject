...
function loadParticipantRequestApproval() {
	...
	$.ajax({
		"url" : "/academicactivity/getAllParticipantRequestFacultyRecom",
		"method" : "GET",
		success : function(data) {
...
<div class="card-header">
   <h3>Administrative Approval for Participation Request</h3>
</div>
<div class="card-body">
<div class="row">
               ...
               <div style="width: 100%">
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="adminstrativeStatus"
                        ...
                        <option value="se">Select</option>
                        <option value="adminstrativeOfficeapproved">Approve</option>
                        <option value="adminstrativeOfficerejected">Reject</option>
