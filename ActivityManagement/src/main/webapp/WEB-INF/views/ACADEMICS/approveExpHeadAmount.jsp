...
function loadAllExpHeadDetails() {
	$.ajax({
		"url" : "/expenditurehead/getAllExpHeadDetailswithoutStatus",
		"method" : "GET",
		success : function(data) {
			...
			onDataTableClick('expHeadTable', function() {
				        ...
				        $('#descriptionId').val(selectedRowFromDataTable[1]);
						$('#finYearId').val(selectedRowFromDataTable[2]);
						$('#fundAmountId').val(selectedRowFromDataTable[3]);
						
						var status=selectedRowFromDataTable[4];
						
						$.ajax({
							"url" : "/expenditurehead/getExpHeadsrecordBydescriptionAndFinyear",
							"method" : "GET",
							"data":{"description":selectedRowFromDataTable[1],"finyear":selectedRowFromDataTable[2]},
							
							success : function(data) {
								$('#expVerifiedRemarksId').val(data['expVerifiedRemarks']);
							},
							error : function(e) {
...
$('#expHeadTypeDetailsForm').unbind().bind('submit',function(event) 
{
			...
			var formCheck = "success";
				...
				$('#confId').unbind().bind('click',function(){
					...
					$.ajax({
						"url" : "/expenditurehead/approveExpenditureHead",
						"method" : "POST",
						 data : formData,
						 success : function(data) {
							console.log(data);
							...
							//centreDialog("Success",data,"green");
		   	   	  		//showMessage(data);
		   	   	  		if(data=='Error in Approving Expenditure Fund Details.')
										{
...
<div class="card card-info card-outline">
	...
	<div class="card-header">
		<h3>Approve Expenditure Head Amount Details </h3>
	...
	<div class="card-body">
		<form id="expHeadTypeDetailsForm">
			...
			<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
		    <div class="form-group">
              	<label for="activitytype">Verified Remarks</label> <textarea id="expVerifiedRemarksId" name="expVerifiedRemarks" rows="4" cols="50"
		...
		<div class="row">
			<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
		    <div class="form-group">
              	<label for="activitytype">Approve Remarks</label> <textarea id="expApprovedRemarksId" name="expApprovedRemarks" rows="4" cols="50"
                  class="form-control"></textarea>
            </div>
            </div>
            </div>
