...
function loadAllAcademicActivityTypeDetails() {
	...
	$.ajax({
		"url" : "/academic/getAllActivityTypes",
		"method" : "GET",
...
$( "#verifyBtn" ).on('click',function(event) {
		...
		/*if(dc == "")
		{
			...
			console.log($('#activityTypeCodeId').val());
				...
				console.log(l1rem);
				$.ajax({
					"url" : "/academic/updateActivityType",
					"method" : "GET",
					...
					$.ajax({
						...
						success : function(data) {
							...
							if(data == "NOTVERIFIED")
							{
								...
								centreDialog("Error","some thing error in updation","red");
								
								
							}
							else
							{
								centreDialog("Success","Verified success fully" ,"green");
	   ...
	   <fieldset  id="fldset">
	  		<div class="row" id="activityTypeRowId">
				<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
			        ...
			        <input type="text" id="approvedDate"  name="approvedDate" class="form-control dp"></input>
			       </div>
				...
				<div class=" col-lg-6 col-md-6 col-sm-12 col-xs-12">
					...
					<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
		  	<label for="geoCoordinatesId">Verified  Remarks<span class="required">*</span></label>			  
			<textarea  class="form-control" rows="5" id="u_v_remarksId" name="verifiedRemarks" required></textarea> 
		    </div>	
		 	<div class="form-group" >			
			<button type="submit" class="btn btn-danger" style="float:left">Verify</button>				
