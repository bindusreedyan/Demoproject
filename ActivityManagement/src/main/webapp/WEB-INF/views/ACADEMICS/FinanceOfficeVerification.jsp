...
function getAllActivityFinancialOfficeApprovedByLogin() {
	console.log("loadAllActivityAcademicallyApproved");
	$.ajax({
		"url" : "/academicactivity/getAllActivityFinancialOfficeApprovedByLogin",
		"method" : "GET",
...
function loadAllActivityForAcademicApproval() {
	...
	$.ajax({
		"url" : "/academicactivity/getAllActivityAdministativeApproved",
		"method" : "GET",
		success : function(data) {
...
{			
   ...
   getAllActivityFinancialOfficeApprovedByLogin();
	$('.dp').datepicker({
	    format: 'yyyy-mm-dd',							   
		autoclose:true,
		clearBtn:true
...
$( "#formCenterActivityDetails" ).submit(function( event ) {
	...
	//alert( "Handler for .submit() called." );
	    ...
	    event.preventDefault();
	     $.ajax({
		   	"url":"/academicfinance/updateActivityFinanceverification",
		   	"method":"POST",
		   	"data":formData2,
		    success:function(data)
		   	 {
...
<div  id="activityApproval" class="card card-info card-outline">
   <div class="card-header">
      <h3><center>Activity Finance Office Verification</center></h3>
   </div>
   <div class="card-body">
      <form id="formCenterActivityDetails" enctype="multipart/form-data">
         <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
               <label for="activitytype"> Name/Title of the Programme</label> <input
            ...
            <!--  <input class="file"  id="brochureURLId" name="brochureURL" type="file" ext="jpg" required></input>   -->
              ...
              <div class="form-group row"  class="col-sm-3"> <button type="button" id="totalExpenditure" class="btn btn-primary">Get Total Estimate Expenditure</button></div>
        <!--          <div class="form-group row">
              ...
              <h5 style="text-decoration: underline;">Details of advance Requirement if Any
               ...
               <textarea id="adminApprovedRemarksId" name="adminApprovedRemarks" rows="4" cols="50"
                  ...
                  <div class="form-group">
               <label for="activityLevel">Finance Office Approval<span
               ...
               <div style="width: 100%">
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="approvesStatus"
                        ...
                        <option value="finance office verified">Approve</option>
                        <option value="finance office rejected">Reject</option>
...
<div  id="gridRow" class="card card-info card-outline">
  	<div class="card-header">
		  <h3>List Of Activities Financially Office Approved</h3>
