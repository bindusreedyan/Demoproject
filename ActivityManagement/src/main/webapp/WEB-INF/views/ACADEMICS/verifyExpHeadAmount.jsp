...
$('#expHeadTypeDetailsForm').unbind().bind('submit',function(event) 
{
			...
			var formCheck = "success";
				...
				$('#confId').unbind().bind('click',function(){
					...
					$.ajax({
						"url" : "/expenditurehead/verifiyExpenditureHead",
						"method" : "POST",
						 data : formData,
						 success : function(data) {
							console.log(data);
									...
									if(data=='Error in verifiying Expenditure Fund Details.')
										{
...
<div class="card card-info card-outline">
	...
	<div class="card-header">
		<h3>Expenditure Head Amount Details Verification</h3>
		...
		<form id="expHeadTypeDetailsForm">
		    ...
		    <div class="form-group">
				...
				<div class="form-group" style="text-align: center">
					<button type="submit" id="verifybtnid" class="btn btn-primary" disabled="disabled">VERIFY</button>
				</div>
