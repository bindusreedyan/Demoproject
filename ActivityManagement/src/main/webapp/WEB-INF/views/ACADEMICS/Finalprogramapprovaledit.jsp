...
function loadAllActivityForFinalApproval() {
	...
	$.ajax({
		"url" : "/academicactivity/getAllActivityFinallyApprovedBuLogin",
		"method" : "GET",
				...
				if(selectedRowFromDataTable != null)
				{
					...
					$.ajax({
									...
									$('#dateToId').val(data_splits2[0]);
										...
										$('#financialfinalApprovedRemarksId').val(data['finalApprovedRemarks']);
	     ...
	     $("#activityFinalApproval" ).on('click',function(event) {
	    	 var finalApprovalRemarks=$('#financialfinalApprovedRemarksId').val();
		   	...
		   	$.ajax({
		   				...
		   				"method":"GET",
		   				 data : {"activityId":activityId,"finalApprovalRemarks":finalApprovalRemarks,"userCode":userCode},
		   				success:function(data)
		   				{
		   					if(data)
		   					{
