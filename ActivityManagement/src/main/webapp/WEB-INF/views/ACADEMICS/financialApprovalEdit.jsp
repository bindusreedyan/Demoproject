				...
				if(selectedRowFromDataTable != null)
				{
					...
					$.ajax({
									...
									success : function(data) 
									{
										...
										$('#activityLevelId').val(data['status']);
...
$.ajax({
	...
	"method":"GET",
	 data:{"activityId":activityId,"centerarray":centerarray.toString(),"balassignArray":balassignArray.toString(), "expIncurredArray":expIncurred.toString(),"estimateHeadsArray":estimateHeadsArray.toString(),"seminarHeadsArray":seminarHeadsArray.toString(),"lectureHeadsArray":lectureHeadsArray.toString(),"externlfundArray":externlfundArray.toString(),"ugcFundArray":ugcFundArray.toString()},
	 success:function(data)
	 {
...
<div  id="activityApproval" class="card card-info card-outline">
   <div class="card-header">
      <h3><center>Edit Form For Financial Approved Activities/Programms</center></h3>
   </div>
   <div class="card-body">
