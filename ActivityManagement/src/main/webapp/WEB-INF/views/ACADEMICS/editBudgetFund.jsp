		...
		//	formData.push({"budHeadId":budheadId,"finYear":finyear});
			var formCheck = "success";
				...
				$('#confId').unbind().bind('click',function(){
					...
					$.ajax({
						"url" : "/expenditurehead/editBudgetFunds",
						"method" : "POST",
						 data : formData,
						 success : function(data) {
    ...
    <div class="card-body">
	  <form id="budgetFundDetailsForm">
		    ...
		    <div class="form-group">
              	<label for="activitytype">Updated Remarks</label> <textarea id="bfeditedRemarksId" name="bfeditedRemarks" rows="4" cols="50"
                  class="form-control"></textarea>
						...
						<button type="submit" class="btn btn-primary" id="verifybtnid">EDIT</button>		
					</div>
				</div>
	  </form>
	</div>
