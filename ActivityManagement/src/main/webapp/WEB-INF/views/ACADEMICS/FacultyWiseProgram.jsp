...
$(document).ready(function()
{
	...
	$('#btnCallStudents').on('click',function()
			{
		var facultyId=$('#cordinatorId').val();
		alert(facultyId);
		$.ajax(
				{
				"url" : "/academicactivity/getAllProgramReportByFaculty",
				"method" : "GET",
...
<div class="row well" id="selectionPanel">
		<div class="col-md-4">
		     <label for="accountName">Select Faculty</label>
		  <select class="form-control selectpicker"  name="emp_id" id="cordinatorId" required></select>
		</div>
