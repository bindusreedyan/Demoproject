...
function loadAllAcademicActivityTypeDetails() {
	$.ajax({
		"url" : "/academicactivity/getAllActivityFinalApprovedForAsIssue",
		"method" : "GET",
		success : function(data) {
	...
	$('#asGenerationForm').unbind().bind('submit',function(event)
			{
				...
				$('#confId').unbind().bind('click',function(){
					...
					$.ajax({
						"url" : "/academicactivity/asOrderGeneration",
						"method" : "POST",
						 data : formData,
						 success : function(data) {
							console.log(data);
	   					 		...
	   					 		budheadAmnt=parseFloat(amountTobemapped)+parseFloat(budheadAmnt);
	   					   			...
	   					   			var formCheck = "success";
	   					   				...
	   					   				$('#confId').unbind().bind('click',function(){
	   					   					...
	   					   					$.ajax({
	   					   						"url" : "/academicactivity/saveActivityBudgetFund",
	   					   						"method" : "POST",
	   					   						 data : formData,
	   					   						 success : function(data) {
...
<div  id="asGeneration" class="card card-info card-outline">
   <div class="card-header">
      <h3><center>Administrative Sanction</center></h3>
   </div>
            ...
            <div class="row">
              ...
              <div class="form-group">
               ...
               <div class="row">
                <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
               <div class="form-group">
                <label for="activitytype">Abstract Details</label> 
