...
var adminstrativeOfficeApprovalRemarks;
var printEnterRemark;
var financeOfficeApprovalRemarks;
var financeApprovalRemarks;
...
function getAllActivityFinancialcApprovedByLogin() {
	console.log("loadAllActivityAcademicallyApproved");
	$.ajax({
		"url" : "/academicactivity/findAllActivityFinancialApprovedByLogin",
		"method" : "GET",
		success : function(data) {
		  ...
		  ], "financeapproveactivityTable", "select-checkbox");
...
function loadAllActivityForAcademicApproval() {
	...
	$.ajax({
		"url" : "/academicactivity/getAllActivityFinanceOfficepproved",
		"method" : "GET",
		success : function(data) {
				...
				if(selectedRowFromDataTable != null)
				{
					...
					$.ajax({
									...
									success : function(data) 
									{
										...
										adminstRemark=data['administrativeApprovalRemarks'];
										$('#officeApprovedRemarksId').val(data['officeApprovedRemarks']);
										$('#adminApprovedRemarksId').val(adminstRemark);
										$('#financeOfficeApprovedRemarksId').val(data['financeOfficeApprovedRemarks']);
					...
					$('#HonorMore3000').val("no");
						...
						$('#totalAsGrantedId').val(data['totalAsgranted']);
				 	...
				 	//to get all centress
				   	$.ajax({
				   		...
				   		success : function(data) {
							...
							//	 var tr=$('<tr><td>'+centername+'</td><td><input class="centerHeads form-control" id="'+fundallocatedId+'" type="number" name="'+fundallocatedId+'" value="'+allocatedfundamount+'" readonly></input></td><td><input class="centerHeads form-control" id="'+expincuId+'" type="number" value="'+exptilldate+'" name="'+expincuId+'" readonly></input></td><td><input class="balassign form-control" id="'+Balance_exclude_unassignedGrant+'" type="number" name="'+Balance_exclude_unassignedGrant+'" value="0" disabled="disabled"></input></td> <td><input class="estimateHeads form-control" id="'+estimatedExp+'" type="number" name="'+estimatedExp+'" value="0"></input></td> <td><input class="seminarHeads form-control" id="'+natnlsemnrcount+'" type="number" name="'+natnlsemnrcount+'" value="0"></input></td><td><input class="lectureHeads form-control" id="'+lecturecount+'" type="number" name="'+lecturecount+'" value="0"></input></td><tr>');
   					     ...
   					     $.ajax({
							 ...
							 var tr=$('<tr><td>'+centerNameArray[j]+'</td><td><input class="centerHeads form-control" id="'+fundallocatedId+'" type="number" name="'+fundallocatedId+'" value="'+allocatedfundamountArray[j]+'" readonly></input></td><td><input class="exptill form-control" id="'+expincuId+'" type="number" value="'+ expIncurred[j]+'" name="'+expincuId+'" readonly></input></td><td><input class="balassign form-control" id="'+Balance_exclude_unassignedGrant+'" type="number" name="'+Balance_exclude_unassignedGrant+'" value="'+Balance_exclude_unassignedGrantArray[j]+'" readonly></input></td> <td><input class="estimateHeads form-control" id="'+estimatedExp+'" type="number" name="'+estimatedExp+'"  value="'+estimatedExpArray[j]+'"></input></td> <td><input class="seminarHeads form-control" id="'+natnlsemnrcount+'" type="number" name="'+natnlsemnrcount+'"  value="'+natnlsemnrcountArray[j]+'"></input></td><td><input class="lectureHeads form-control" id="'+lecturecount+'" type="number" name="'+lecturecount+'"  value="'+lecturecountArray[j]+'"></input></td><td><input class="unassigrant form-control" id="'+unassignGrant+'" type="number" name="'+unassignGrant+'" value="'+unassignedGrantAmnt[j]+'"></input></td><tr>');
							 $('#centerActivityeBody2').append(tr);
...
{			
   ...
   getAllActivityFinancialcApprovedByLogin();
	$('.dp').datepicker({
	    format: 'yyyy-mm-dd',							   
		autoclose:true,
		clearBtn:true
...
$( "#formCenterActivityDetails" ).submit(function( event ) {
	//alert( "Handler for .submit() called." );
	   	 ...
	   	 adminstrativeOfficeApprovalRemarks=$('#officeApprovedRemarksId').val();
	   	 financeOfficeApprovalRemarks=$('#financialApprovedRemarksId').val();
	   	financeOfficeRemarks=$('#financialApprovedRemarksId').val();
	    ...
	    event.preventDefault();
	     $.ajax({
		   	"url":"/academicfinance/updateActivityFinance",
		   	"method":"POST",
		   	"data":formData2,
		    success:function(data)
		   	 {
...
//add advance estimate request ajax call
 ...
 //  if((updateActivityCenterFinanceflag=="true")&&(addActivityFinanceflag=="true")&&(addActivityEstimateflag==true)&&(addActivityAdvanceEstimateRequestflag=="true"))
 	 // {
 	  showMessage("successfully submitted the activity finance details of activity "+activityId);
 	  
 	  
 	 $('#printBt').attr('disabled', false);
 	 finRemark=$('#financialApprovedRemarksId').val();
...
//else
 	//{
 	//showMessage("error is occured while adding finance approval details");
 	//}
 	  $("#formCenterActivityDetails").trigger('reset');
   //updateActivityMasterAsno();
			...
			for(var key in d)
				{
				 ...
				 $.ajax({
			                 ...
			                 $('#advtab').append('<thead><tr><th scope="col">Head Of Expenditure</th><th scope="col">Advance Required</th><th scope="col">Briefly State Requirement with reason</th><th scope="col">As Granted Amount</th>');
								 ...
								 $('#adminofficeApprovalRemarkstd').append(adminstrativeOfficeApprovalRemarks);					
								 $('#financeofficeRemarkstd').append(financeOfficeApprovalRemarks);									 
								 $('#financeRemarkstd').append(financeOfficeRemarks);		
...
<div  id="activityApproval" class="card card-info card-outline">
   <div class="card-header">
      <h3><center>Activity For Financial Approval</center></h3>
   </div>
   <div class="card-body">
      <form id="formCenterActivityDetails" enctype="multipart/form-data">
         <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="form-group row">
               ...
               <div id="divGridTable4" class="row" style="display: none">
                 ...
                 <div class="form-group row">
                  ...
                  justification provided as Annexure I ( Academic Approval)</label>
                  <div class="col-sm-6"> 
                           <input class="file"  id="annexureFileId" name="annexureFile" type="file" ext="jpg" required></input> 
                  </div>
               </div>
              <div class="form-group">
            ...
            <!--  <input class="file"  id="brochureURLId" name="brochureURL" type="file" ext="jpg" required></input>   -->
              ...
              <div class="form-group row">
                ...
                <div class="form-group row"  class="col-sm-3"> <button type="button" id="totalEstimatedExpenditure" class="btn btn-primary">Get Total Program Estimated Expenditure </button></div>
        ...
        <!--          <div class="form-group row">
              ...
              <h5 style="text-decoration: underline;">Details of Advance Requirement if Any
               ...
               <div class="form-group">
               <label for="remarks"> Administrative Office Approval Remarks</label>
               <textarea id="officeApprovedRemarksId" name="officeApprovedRemarks" rows="4" cols="50"
                  class="form-control"></textarea>
            </div>
              ...
              <div class="form-group">
               <label for="remarks"> Remarks For Financial Office Approval</label>
               <textarea id="financeOfficeApprovedRemarksId" name="financeOfficeApprovedRemarks" rows="4" cols="50"
                  class="form-control"></textarea>
            </div>
                  <div class="form-group">
               ...
               <div style="width: 100%">
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="approvesStatus"
                        id="activityLevelId" required>
                        <option value="">Select</option>
                        <option value="financially approved">Approve</option>
            ...
            <div class="form-group">
               ...
               <textarea id="financialApprovedRemarksId" name="approvedRemarks" rows="4" cols="50"
                  class="form-control"></textarea>
            </div>
...
<div  id="gridRow" class="card card-info card-outline">
    ...
    <div class="card-body">
	   	<div class="table-responsive">
				<table class="table table-bordered table-hover dataTable dtr-inline collapsed table-sm cell-border" id="financeapproveactivityTable">
	...
	<div class="col-md-12">
		<div class="table-responsive" id="reportDiv" style="display:none">
			<table  id="repTable">
				...
				<tr td colspan="4"><center> FINANCIAL APPROVAL FOR PROGRAMMES CONDUCTED BY NUALS/ VARIOUS  CENTRES OF STUDY AND RESEARCH </center><td></tr>
				<tr><td colspan="4">
				...
				<tr><td id="adminofficeApprovalRemarkstd" colspan="4"></td></tr>     
				<tr><td  colspan="4"><u>Administrative Approval Remarks </u></td></tr>   
				<tr><td id="adminApprovalRemarkstd" colspan="4"></td></tr>  
					<tr><td  colspan="4"><u>Finance office Approval Remarks </u></td></tr>   
				<tr><td id="financeofficeRemarkstd" colspan="4"></td></tr> 
				<tr><td  colspan="4"><u>Finance Approval Remarks </u></td></tr>   
				<tr><td id="financeRemarkstd" colspan="4"></td></tr> 
