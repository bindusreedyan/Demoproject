...
$('#expHeadForm').unbind().bind('submit',function(event) 
{
			...
			var formCheck = "success";
				...
				$('#confId').unbind().bind('click',function(){
					...
					$.ajax({
						"url" : "/expenditurehead/verifyExpenditureHeadNames",
						"method" : "POST",
						 data : formData,
						 success : function(data) {
							console.log(data);
...
<div class="card card-info card-outline">
 	<div  id="gridRow" class="card card-info card-outline">
  	<div class="card-header">
		  <h3>Expenditure Head Name Details</h3>
    ...
    <div class="card-body">
	  <form id="expHeadForm">
			...
			<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
		    <div class="form-group">
              	<label for="activitytype">Verify Remarks</label> <textarea id="expApprovedRemarksId" name="verifiedRemark" rows="4" cols="50"
