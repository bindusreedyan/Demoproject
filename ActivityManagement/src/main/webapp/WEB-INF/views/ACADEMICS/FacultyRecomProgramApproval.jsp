	   ...
	   $("#activityFinance" ).unbind().bind('click',function(event) {
		...
		$( "#formCenterActivityDetails" ).submit(function( event ) {
			//alert( "Handler for .submit() called." );
			    ...
			    event.preventDefault();
			     $.ajax({
				   	"url":"/academicfinance/facultyApproval",
				   	"method":"POST",
				   	"data":formData2,
				    success:function(data)
				   	 {
		...
		//add advance estimate request ajax call
		   ...
		   $.ajax({
		 	  ...
		 	  showMessage("faculty Approval successfully done "+activityId);
      ...
      <form id="formCenterActivityDetails" >
         ...
         <div class="form-group">
              ...
              <h5 style="text-decoration: underline;">Details of advance Requirement if Any
               ...
               <div style="width: 100%">
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="facultyApprovesStatus"
                        id="approvedStatusId" required>
                        <option value="">Select</option>
                        <option value="faculty recommended">Approve</option>
                        <option value="faculty Rejected ">Reject</option>
