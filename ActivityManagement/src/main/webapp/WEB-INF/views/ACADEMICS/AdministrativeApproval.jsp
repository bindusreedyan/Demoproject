...
function loadAllActivityForAcademicApproval() {
	...
	$.ajax({
		"url" : "/academicactivity/getAllActivityForAdministrativeApprovedBylevel2",
		"method" : "GET",
		success : function(data) {
...
$( "#formCenterActivityDetails" ).submit(function( event ) {
	...
	printEnterRemark =$('#remarksId').val()
	 ...
	 adminstrativeOfficeApprovalRemarks=$('#officeApprovedRemarksId').val();
	    ...
	    event.preventDefault();
	     $.ajax({
		   	"url":"/academicfinance/administrativeApproval",
		   	"method":"POST",
		   	"data":formData2,
		    success:function(data)
		   	 {
...
//add advance estimate request ajax call
   ...
   $.ajax({
 	 ...
 	 // showMessage("Administrative Approval successfully done "+activityId);
 	  centreDialog("Success","Administrative Approval successfully done","green");
...
<div  id="activityApproval" class="card card-info card-outline">
   <div class="card-header">
      <h3><center>Administrative Approval of Activities/Programmes</center></h3>
   </div>
   <div class="card-body">
      <form id="formCenterActivityDetails" >
         <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row">
              ...
              <h5 style="text-decoration: underline;">Details of Advance Requirement if Any
               ...
               <div class="form-group row">
                  ...
                  <div class="form-group row">
                  <label for="activitytype" class="col-sm-6 col-form-label">Remarks 
                   </label>
                  <div class="col-sm-6">
                     <input type="text" name="remarks" class="form-control"
                        id="remarksId" required>
                  </div>
               </div>
               ...
               <div style="width: 100%">
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="approvesStatus"
                        ...
                        <option value="administrativeapproved">Reject</option>
            ...
            <div class="form-group">
               ...
               <textarea id="administrativeApprovalRemarksId" name="approvedRemarks" rows="4" cols="50"
                  class="form-control"></textarea>
            </div>
	...
	<div class="col-md-12">
		<div class="table-responsive" id="reportDiv" style="display:none">
			<table  id="repTable">
				...
				<tr td colspan="4"><center> REQUEST FOR ADMINISTRATIVE APPROVAL FOR PROGRAMMES CONDUCTED BY NUALS/ VARIOUS  CENTRES OF STUDY AND RESEARCH </center><td></tr>
				<tr><td colspan="4">
