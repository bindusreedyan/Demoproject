...
function loadAllActivityForFinalApproval() {
	...
	$.ajax({
		"url" : "/academicactivity/getAllActivitesForRevision",
		"method" : "GET",
		success : function(data) {
	   		    ...
	   		    $.ajax(
	   	   		{
	   				...
	   				"method":"POST",
	   	  		   ...
	   	  		   $.ajax({
							...
							"method" : "GET",
							 data : {"activityId":activityId,"resId":data['resId']},
	...
	formData.push({"name":"activityCode","value":activityId});
   			...
   			var formCheck = "success";
   				...
   				$('#confId').unbind().bind('click',function(){
   					...
   					$.ajax({
   						"url" : "/academicactivity/editActivityMasterForAsRevision",
   						"method" : "POST",
   						 data : formData,
   						 success : function(data) {
   							console.log(data);
		...
		$( "#formCenterActivityDetails" ).submit(function( event ) {
	    	...
	    	$('.exptill').attr('disabled',false);
				...
				formData2.push({"name":"activityFinanceCode","value":activityFinanceId});
			     ...
			     $.ajax({
				   	"url":"/academicfinance/editActivityFinanceForAsRevision",
				   	"method":"POST",
				   	"data":formData2,
				    success:function(data)
				   	 {
...
<div class="card card-info card-outline">
   <div class="card-header">
      <h3>Program Approval For As Revision</h3>
   </div>
<div class="card-body">
<div class="row">
