...
$.ajax(
{
"url" : "/academicactivity/getAllExpenditureSettled",
"method" : "GET",
success : function(data)
{
setUpDataTable(data,[{"programCat":"programCategory"},{"programType":"programType"},{"center":"Conducted By"},{"from":"From"},{"to":"To"},{"totalExp":"Total Expenditure"},{"programStatus":"Current Status"},{"empName":"Employee Name"},{"asSanctionDate":"As Granted Date"},{"asAmount":"As Granted Amount"}],"gridTable",null);
