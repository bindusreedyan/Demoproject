...
function loadAllVendorDetails() {
	...
	$.ajax({
		"url" : "/vendors/getAllVendorDetailsWithoutStatus",
		"method" : "GET",
		 data:{"vendorStatus":status},
		  success : function(data) {
			...
			onDataTableClick('vendorMasterTable', function() {
				...
				var vendorStatus=selectedRowFromDataTable[3];
				...
				$.ajax({
				 ...
				 if(vendorStatus=="checked")
				 {
				 $('#vendorMasterDetailsBt').attr('disabled',false);
				 }
			 else
				 {
				 $('#vendorMasterDetailsBt').attr('disabled',true);
				 }
		   			...
		   			var formData = $(this).serializeArray();
		   		     formData.push({"name":"vendorId","value":vendorId});
		   				...
		   				$('#confId').unbind().bind('click',function(){
		                     ...
		                     var i=0;
		   					$.ajax({
		   						"url" : "/vendors/verifyVendorDetails",
		   						"method" : "POST",
		   						 data : formData,
		   						 success : function(data) {
		   							...
		   							if(data=='Error is occured while verifying details')
									{
...
<div id="gridRow" class="card card-info card-outline">
	<div class="card-header">
		<h3>List Of Vendor Details For Verification</h3>
...
<div class="card card-info card-outline">
	<div class="card-header">
		<h3>Vendor Details Verification</h3>
	</div>
	  ...
	  <fieldset  id="fldset">
		<form id="vendorMasterForm">
		   ...
		   <div class="row">
			...
			<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
		    <div class="form-group">
              	<label for="activitytype">Checked Remarks</label> <textarea id="vendorCheckedRemarksId" name="vendorCheckedRemarks" rows="4" cols="50"
                  class="form-control"></textarea>
            </div>
            </div>
            </div>
			...
			<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
		    <div class="form-group">
              	<label for="activitytype">Verified Remarks</label> <textarea id="vendorVerifiedRemarksId" name="vendorVerifiedRemarks" rows="4" cols="50"
                  class="form-control"></textarea>
            </div>
            </div>
            </div>
				...
				<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						 <button type="submit" id="vendorMasterDetailsBt" class="btn btn-primary" style="float:Center" disabled="disabled">VERIFY</button>
