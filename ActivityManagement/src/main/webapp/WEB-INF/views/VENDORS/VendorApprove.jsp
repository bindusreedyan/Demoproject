				...
				$.ajax({
						...
						var myOptions1 = {
								...
								$.each(myOptions1, function(val, text) {
								    $('#approvedStatusId').append( new Option(text,val) );
								});	 
						 },
						 error(e)
   						 {
		   			...
		   			var formData = $(this).serializeArray();
		   		     formData.push({"name":"vendorId","value":vendorId});
		   				...
		   				$('#confId').unbind().bind('click',function(){
		                     ...
		                     var i=0;
		   					$.ajax({
		   						"url" : "/vendors/approveVendorDetails",
		   						"method" : "POST",
		   						 data : formData,
		   						 success : function(data) {
	  ...
	  <fieldset  id="fldset">
		...
		<div class="row">
		    ...
		    <div class="form-group">
				...
				<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						 <button type="submit" id="vendorMasterDetailsBt" class="btn btn-primary" style="float:Center" disabled="disabled">APPROVE</button>
		    </div>
			</div>
			</div>
		</form>
