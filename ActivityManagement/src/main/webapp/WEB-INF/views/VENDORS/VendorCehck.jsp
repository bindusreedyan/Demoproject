		   			...
		   			var formData = $(this).serializeArray();
		   		     formData.push({"name":"vendorId","value":vendorId});
		   				...
		   				$('#confId').unbind().bind('click',function(){
		                     ...
		                     var i=0;
		   					$.ajax({
		   						"url" : "/vendors/checkVendorDetails",
		   						"method" : "POST",
		   						 data : formData,
		   						 success : function(data) {
		   					
		   							if(data=='Error is occured while checking details')
									{
		...
		<form id="vendorMasterForm">
		   ...
		   <div class="row">
		    ...
		    <div class="form-group">
				...
				<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						 <button type="submit" id="vendorMasterDetailsBt" class="btn btn-primary" style="text-align: center">CHECK</button>
