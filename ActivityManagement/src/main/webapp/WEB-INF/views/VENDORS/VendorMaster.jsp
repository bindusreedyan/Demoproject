		   					...
		   					$.ajax({
		   						...
		   						"method" : "POST",
		   						 ...
		   						 success : function(data) {
		   							...
		   							//showMessage(data);
		   							if(data=='Error is occured while adding details')
		   								{
		   								centreDialog("Error",data,"red");
		   								}
		   							else
		   								{
		   								centreDialog("Success",data,"red");
		   								}
		   							loadAllVendorDetails();
		    ...
		    <div class="form-group">
				...
				<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-group" style="text-align: center">
						 <button type="submit" id="vendorMasterDetailsBt" class="btn btn-primary">Submit</button>
     			</div>
			</div>
			</div>
