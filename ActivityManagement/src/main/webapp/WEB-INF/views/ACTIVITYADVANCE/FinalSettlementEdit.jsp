						...
						success:function(data)
					 	...
					 	$.ajax({
					   		...
					   		success : function(data) {
					   			...
					   			$('#activityLevelId').val(data['advSettlementStatus']);
					   			$('#approvedRemarksId').val(data['approvedRemarks']);
...
<div class="card-header">
   <h3>Edit Final Approval For Expenditure Sanction / Settlement of Advance - Details of Bills , Vouchers and utilisation of Advance</h3>
</div>
<div class="card-body">
<div class="row">
