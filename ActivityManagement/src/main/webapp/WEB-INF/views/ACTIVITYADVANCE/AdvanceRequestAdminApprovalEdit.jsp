...
function loadAllAcademicActivityTypeDetails() {
	$.ajax({
		"url" : "/academicactivity/getAllActivityAdminiApprovedByFaculty",
		"method" : "GET",
				      ...
				      if((totalAdvanceRequestedupdated>eligbleamnt)>0)
				      {
				  	   ...
				  	   //showMessage("requested amnt exceeds your advance limit pls enter the reason in remarks field");
								...
								$('#confId').unbind().bind('click',function(){
									...
									$.ajax({
										"url" : "/academicactivity/adminAdvanceRequestEdit",
										"method" : "POST",
										 data : formData,
										 success : function(data) {
											console.log(data);
...
<div class="card card-info card-outline">
	<div class="card-header">
		<h3>Edit Administrative Approval for Advance Request By Faculty</h3>
	</div>
