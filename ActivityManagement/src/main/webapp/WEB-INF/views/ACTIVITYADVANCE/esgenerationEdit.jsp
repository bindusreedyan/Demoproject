		...
		success : function(data) {
		   ...
		   setUpDataTable(data, [ 
			...
			onDataTableClick('finallySettledActivityTable', function() {
				...
				orderGenId=selectedRowFromDataTable[6];
				//alert(settlementId);
						$.ajax({
	...
	$('#asGenerationForm').unbind().bind('submit',function(event)
			{
				...
				$('#confId').unbind().bind('click',function(){
					...
					$.ajax({
						"url" : "/academicactivity/esOrderGenarationEdit",
						"method" : "POST",
						 data : formData,
						 success : function(data) {
							console.log(data);
							if(data==null)
								...
								{
								showMessage("Es order is Successfully edited");
