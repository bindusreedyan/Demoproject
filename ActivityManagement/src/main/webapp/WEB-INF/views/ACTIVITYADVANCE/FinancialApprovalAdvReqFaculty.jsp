			    			...
			    			success:function(data)
			    				...
			    				if(data)
			    					{	
                                           ...
                                           $.ajax({
               				    			"url":"/academicactivity/getAdvRequestNotSettledByFaculty",
               				    			"method":"GET",
               				    			 data:{"userCode":userCode},
               				    			 success:function(data)
               				    				{
		    	...
		    	$('#amtSanctionedASId').attr('disabled',false);
                  ...
                  var totalAdvanceRequestedupdated=totalAdvanceRequested+parseFloat($('#totalAdvanceRequestedId').val());
				      ...
				      if((totalAdvanceRequestedupdated>eligbleamnt)>0)
				      {
				    	  ...
				    	  confirm("requested amnt exceeds your advance limit");
...
<div class="card card-info card-outline">
	<div class="card-header">
		<h3>Financial Approval for Advance Request By Faculty</h3>
	</div>
	...
	<div class="col-md-12">
		<div class="table-responsive" id="reportDiv" style="display: none">
			<table class="table table-striped" id="repTable">
				...
				<tr><td>Finance Office Remarks</td></tr>
				<tr><td id="financeOfficeApprovedRemark"  colspan="4"></td></tr>
				<tr><td>Finance Remarks</td></tr>
				<tr><td id="commentsFinance"  colspan="4"></td></tr>
