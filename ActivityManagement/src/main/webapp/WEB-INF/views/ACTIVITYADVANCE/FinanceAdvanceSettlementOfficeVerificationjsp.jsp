		 ...
		 $('#remarkssForm').unbind().bind('submit',function(event) 
			...
			// financeOfficeApproval=$('#verifiedL1RemarksId').val();
			 ...
			 financeOfficeApproval=$('#financialOfficeRecommendationRemarkId').val();
				   			...
				   			constrainError="could not execute statement; SQL [n/a]; constraint [uk_dv7ekuwotvvykbxcwxyqas0gl]; nested exception is org.hibernate.exception.ConstraintViolationException: could not execute statement";
				   			$.ajax({
		   						"url" : "/academicactivity/saveSettlementFinanceOfficeRemarks",
		   						"method" : "POST",
		   						 data : formData,
		   						 success : function(data) {
...
<div class="card-header">
   <h3>Finance Office Verification Of Expenditure Sanction / Settlement of Advance - Details of Bills , Vouchers and utilisation of Advance</h3>
</div>
<div class="card-body">
<div class="row">
        ...
        <div id="officeUseDiv">
         ...
         <div class="collapse" id="proceduralRequirementsDiv">
          ...
          <div class="form-group">
               ...
               <div style="width: 100%">
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="recommendationStatus"
                        ...
                        <option value="">Select</option>
                        <option value="FinanceOfficeApproved">Approve</option>
                        <option value="FinanceOfficeRejected">Reject</option>
             ...
             <div class="form-group">
              	<label for="enteredRemarks">Finance Approval Remarks</label> <textarea id="financialOfficeRecommendationRemarkId" name="financialOfficeRecommendationRemark" rows="4" cols="50"
                  class="form-control"></textarea>
             </div>
