...
function loadAllExpenditureDetailsSubmitted() {
	$.ajax({
		"url" : "/academicactivity/loadAllExpenditureDetailsFinanceApproved",
		"method" : "GET",
		success : function(data) {
		 ...
		 $('#remarkssForm').unbind().bind('submit',function(event) 
			...
			// financeOfficeApproval=$('#verifiedL1RemarksId').val();
			 ...
			 console.log("entrrr in remarkssForm");  
				   			...
				   			constrainError="could not execute statement; SQL [n/a]; constraint [uk_dv7ekuwotvvykbxcwxyqas0gl]; nested exception is org.hibernate.exception.ConstraintViolationException: could not execute statement";
				   			$.ajax({
		   						"url" : "/academicactivity/saveSettlementFinalOfficeRemarks",
		   						"method" : "POST",
		   						 data : formData,
		   						 success : function(data) {
...
<div  id="gridRow" class="card card-info card-outline">
  	<div class="card-header">
		  <h3 > Final Office Approval  for Expenditure Sanction / Settlement of Advance Details against Program</h3>
  	</div>
    <div class="card-body">
...
<div class="card-header">
   <h3>Final Office Approval For Expenditure Sanction / Settlement of Advance - Details of Bills , Vouchers and utilisation of Advance</h3>
</div>
<div class="card-body">
<div class="row">
         ...
         <div class="collapse" id="proceduralRequirementsDiv">
          ...
          <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="form-group">
               <label for="activityLevel">Final Office Approval<span
                  class="required">*</span></label>
               <div style="width: 100%">
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="recommendationStatus"
                        ...
                        <option value="">Select</option>
                        <option value="FinalOfficeApproved">Approve</option>
                        <option value="FinalOfficeRejected">Reject</option>
