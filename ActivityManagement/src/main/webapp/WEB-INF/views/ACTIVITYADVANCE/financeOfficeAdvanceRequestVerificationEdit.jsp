...
function loadAllAcademicActivityTypeDetails() {
	$.ajax({
		"url" : "/academicactivity/getAllAdvanceRequestfinanceofficeapproved",
		"method" : "GET",
			    			...
			    			success:function(data)
			    				...
			    				if(data)
			    					{	
                                           ...
                                           $('#financeOfficeApprovedRemarkId').val(data['financeOfficeApprovedRemark']);
                                           $('#sanctionedAmtId').val(data['sanctionedAmt']);
                                           $('#advanceReqStatusId').val(data['advanceReqStatus']);
                                           $.ajax({
				      ...
				      if((totalAdvanceRequestedupdated>eligbleamnt)>0)
				      {
				  	   ...
				  	   //showMessage("requested amnt exceeds your advance limit pls enter the reason in remarks field");
								...
								$('#confId').unbind().bind('click',function(){
									...
									$.ajax({
										"url" : "/academicactivity/financeOfficeApprovalAdvanceRequest",
										"method" : "POST",
										 data : formData,
										 success : function(data) {
											console.log(data);
...
<div class="card card-info card-outline">
	<div class="card-header">
		<h3>Edit Finance Office Approval For Advance Request By Faculty</h3>
	</div>
	<div class="card-body" id="advReq">
		<form id="advReqForm">
			...
			<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
		    <div class="form-group">
               <label for="remarks">Finance Approval Remarks</label>
               <textarea id="financeOfficeApprovedRemarkId" name="financeOfficeApprovedRemark" rows="4" cols="50"
                  class="form-control"></textarea>
            </div>
            </div>
            </div>
