...
var adminapprovalreamrks;
var sectionRemark;
var financeOfficeApproval;
var financeApproval;
var finalofficeapproval;
var  advrecieved;
var finalapproval;
...
function loadAllExpenditureDetailsSubmitted() {
	$.ajax({
		"url" : "/academicactivity/loadAllExpenditureDetailsFinalOfficeApproved",
		"method" : "GET",
		success : function(data) {
						...
						success:function(data)
					 	...
					 	$.ajax({
					   		...
					   		success : function(data) {
					   			...
					   			$('#financialRecommendationRemarkId').val(data['verifiedL3Remarks']);
					   			
					   			$('#finalOfficeRecommendationRemarkId').val(data['finalOfficeRecommendationRemark']);
					   			$('#financialOfficeRecommendationRemarkId').val(data['financeverifiedL2Remarks']);
					   		},
					   		error:function(e)
					   		{
					   			...
					   			onDataTableClick('physicalDelivarablesgridTable',function()
					   				...
					   				/* 	$.ajax({
									   		...
									   		success : function(data) {
									   			...
									   			$('#phyEnteredRemarksId').val(data[0]['enteredRemarks']);
									   			$('#justificationId').val(data[0]['justification']);
...
$(document).ready(function() {
	...
	$( "#tabs" ).tabs({
	 ...
	 $('#expenditureDetailsForm1').unbind().bind('submit',function(event) 
		 ...
		 expenditureId= $('#expHeadNameId').val()
			   	        console.log("entrrr in AmountPaidBackForm");  
			   			event.preventDefault();
			   			var formCheck = "success";
			   			var formData = $(this).serializeArray();
		...
		$.ajax({
		 ...
		 $('#remarkssForm').unbind().bind('submit',function(event) 
			 ...
			 sectionRemark=$('#verifiedL1RemarksId').val();

			// financeOfficeApproval=$('#verifiedL1RemarksId').val();
			 adminapprovalreamrks=$('#adminRecommendationRemarkId').val();
			 financeOfficeApproval=$('#financialOfficeRecommendationRemarkId').val();
			 financeApproval=$('#financialRecommendationRemarkId').val();
			 
			 
			 finalofficeapproval=$('#finalOfficeRecommendationRemarkId').val();
			 finalapproval=$('#approvedRemarksId').val();
				   			...
				   			constrainError="could not execute statement; SQL [n/a]; constraint [uk_dv7ekuwotvvykbxcwxyqas0gl]; nested exception is org.hibernate.exception.ConstraintViolationException: could not execute statement";
				   			$.ajax({
		   						"url" : "/academicactivity/saveSettlementFinalRemarks",
		   						"method" : "POST",
		   						 data : formData,
		   						 success : function(data) {
	 ...
	 var recommended=$('#recommendedId').val()
																	   		...
																	   		success : function(data) {
																   			 ...
																   			 $('#goodspt').append(tr);
																			   	  ...
																			   	  $.ajax({
																				   		...
																				   		data:{"settlementId":settlementId},
																				   		success : function(data) {
																				   			 $('#pdppt').append('<thead><tr><th scope="col">Sl No</th><th scope="col">Physical Deliverables Vis a Vis Actual Performance </th> <th scope="col">AS Granted</th><th scope="col">Actual </th><th scope="col">Deviation</th><th scope="col">Justification</th>');
																							 
																							 	for(var i=0;i<data.length;i++)
																								{
																							 		  var sino=i+1;
																							   			 tr=$('<tr><td>'+sino+'</td><td>'+data[i]['delivarableDescription']+'</td><td>'+data[i]['asGranted']+'</td><td>'+data[i]['actual']+'</td><td>'+data[i]['deviation']+'</td><td>'+data[i]['justification']+'</td>');
																							   			$('#pdppt').append(tr);
																								}
																								...
																								$.ajax({
																		                         ...
																		                         $('#casppt').append('<thead><tr><th scope="col">Sl No</th><th scope="col">Compliance to Administrative Sanction</th> <th scope="col">AS Granted</th><th scope="col">Actual Expenditure </th><th scope="col">Deviation</th><th scope="col">Justification</th>');

																				                  for(var i=0;i<data.length;i++)
																									{
																									var sino=i+1;
																								tr=$('<tr><td>'+sino+'</td><td>'+data[i]['expHead']+'</td><td>'+data[i]['asGranted']+'</td><td>'+data[i]['actual']+'</td><td>'+data[i]['deviation']+'</td><td>'+data[i]['complianceJustification']+'</td></tr>');
																								$('#casppt').append(tr);
																					               }
																								  	...
																								  	$.ajax({
																								   		...
																								   		data:{"settlementId":settlementId},
																								   		success : function(data) {
																								   			 $('#cprppt').append('<thead><tr><th scope="col">Sl No</th><th scope="col">Compliance to Procedural Requirements Check List</th> <th scope="col">Yes/No</th>');

																																							                  for(var i=0;i<data.length;i++)
																																												{
																																												var sino=i+1;
																																											tr=$('<tr><td>'+sino+'</td><td>'+data[i]['complDesc']+'</td><td>'+data[i]['included']+'</td></tr>');
																																											$('#cprppt').append(tr);
																																								               }
																																							                  $('#sectionTd').append(sectionRemark);
																																							                  $('#adminTd').append(adminapprovalreamrks);
																																							                  $('#finoTd').append(financeOfficeApproval);
																																							                  $('#finTd').append(financeApproval);
																																							                  $('#foTd').append(finalofficeapproval)
																																							                    $('#fiTd').append(finalapproval)
...
<div class="card-header">
   <h3>Final Approval For Expenditure Sanction / Settlement of Advance - Details of Bills , Vouchers and utilisation of Advance</h3>
</div>
<div class="card-body">
<div class="row">
         ...
         <div class="collapse" id="proceduralRequirementsDiv">
          ...
          <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
              	<label for="enteredRemarks">Finance Office Approval Remarks</label> <textarea id="financialOfficeRecommendationRemarkId" name="financialOfficeRecommendationRemark" rows="4" cols="50"
                  class="form-control"></textarea>
             </div>
             
             
              <div class="form-group">
              	<label for="enteredRemarks">Finance Approval Remarks</label> <textarea id="financialRecommendationRemarkId" name="financialRecommendationRemark" rows="4" cols="50"
                  class="form-control"></textarea>
             </div>
             
             
               <div class="form-group">
              	<label for="enteredRemarks">Final Office Approval Remarks</label> <textarea id="finalOfficeRecommendationRemarkId" name="finalOfficeRecommendationRemark" rows="4" cols="50"
                  class="form-control"></textarea>
             </div>
          ...
          <div class="form-group">
               ...
               <div style="width: 100%">
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="recommendationStatus"
                        ...
                        <option value="">Select</option>
                        <option value="FinalApproved">Approve</option>
                        <option value="FinalRejected">Reject</option>
              ...
              <div class="form-group">
              	<label for="enteredRemarks">Final Approval Remarks</label> <textarea id="approvedRemarksId" name="finalRecommendationRemark" rows="4" cols="50"
                  class="form-control"></textarea>
             </div>
...
<div class="modal fade" id="expenditureDetailsFormId1" tabindex="-1"
   ...
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Add Expenditure Admissible Amount
            </h5>
            <button type="button" class="close" data-dismiss="modal"
               aria-label="Close">
            <span aria-hidden="true">&times;</span>
	...
	<div class="col-md-12">
		<div class="table-responsive" id="reportDiv" style="display:none">
			<table class="table table-striped" id="repTable">
			   ...
			   <tr><td colspan="4"><u>For Office Use Only</u></td></tr>
			    <tr><td colspan="4"><u>Physical Deliverables Vis a Vis Actual Performance</u></td></tr>
			   <tr><td><table id="pdppt" class="table table-striped"></table></td></tr> 
			    <tr><td colspan="4"><u>Compliance to Administrative Sanction</u></td></tr>
			   <tr><td><table id="casppt" class="table table-striped"></table></td></tr> 
			   
			     <tr><td colspan="4"><u>Compliance to Procedural Requirements Check List</u></td></tr>
			   <tr><td><table id="cprppt" class="table table-striped"></table></td></tr> 
			    <tr><td colspan="7">Certified that the bills and vouchers in this expenditure statement is duly verified. Also certified that the expenditure was incurred for the programme as approved by NUALS.The Items purchased if any were duly verified for quality and quantity and was taken in stock and properly recorded for any further verification that may be required.Any unused balance of stock is returned to the university. The services availed for the above purpose have been fully received used and certified.</td></tr> 
			     <tr><td colspan="4"><u>Section Officer Remark</u></td></tr>
			       <tr><td colspan="4" id="sectionTd"></td></tr>
			         <tr><td colspan="4"><u>Administrative Approval Remark</u></td></tr>
			       <tr><td colspan="4" id="adminTd"></td></tr>
			         <tr><td colspan="4"><u>Finance Office Remark</u></td></tr>
			       <tr><td colspan="4" id="finoTd"></td></tr>
			        <tr><td colspan="4"><u>Finance Remark</u></td></tr>
			       <tr><td colspan="4" id="finTd"></td></tr>
			           <tr><td colspan="4"><u>Final Officer Remark</u></td></tr>
			       <tr><td colspan="4" id="foTd"></td></tr>
			        <tr><td colspan="4"><u>Final Remark</u></td></tr>
			       <tr><td colspan="4" id="fiTd"></td></tr>
