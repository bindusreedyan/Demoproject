...
function loadAllAcademicActivityTypeDetails() {
	$.ajax({
		"url" : "/academicactivity/getAllAdvanceRequestAdminOfficeApproved",
		"method" : "GET",
				      ...
				      if((totalAdvanceRequestedupdated>eligbleamnt)>0)
				      {
				  	   ...
				  	   //showMessage("requested amnt exceeds your advance limit pls enter the reason in remarks field");
								...
								$('#confId').unbind().bind('click',function(){
									...
									$.ajax({
										"url" : "/academicactivity/adminOfficeApprovalAdvanceRequest",
										"method" : "POST",
										 data : formData,
										 success : function(data) {
											console.log(data);
...
<div class="card card-info card-outline">
	<div class="card-header">
		<h3>Edit Administrative Office Approval For Advance Request By Faculty</h3>
	</div>
               ...
               <label for="activityLevel">Administrative Office Approval<span
                  ...
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="advanceReqStatus"
                        ...
                        <option value="se">Select</option>
                        <option value="AdminOfficeApproved">Approve</option>
                        <option value="AdminOfficeRejected">Reject</option>
	...
	<div class="col-md-12">
		<div class="table-responsive" id="reportDiv" style="display: none">
			<table class="table table-striped" id="repTable">
				...
				<tr><td colspan="4"><center>Administrative Office Approval of Requisition for Advance  Faculty/ Staff</center></td></tr>
