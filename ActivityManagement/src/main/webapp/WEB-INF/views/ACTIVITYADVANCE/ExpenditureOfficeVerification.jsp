					 ...
					 /* 	$.ajax({
					  ...
					  /* 	$.ajax({
					   		...
					   		var totalUniversitypaidBack=$('#totalPaidBackId').val();
					   		    ...
					   		    $('#amntPaidBackId').val(totalUniversitypaidBack);
		...
		$.ajax({
		 ...
		 $('#remarkssForm').unbind().bind('submit',function(event) 
			 ...
			 console.log("entrrr in remarkssForm");  
				   			...
				   			constrainError="could not execute statement; SQL [n/a]; constraint [uk_dv7ekuwotvvykbxcwxyqas0gl]; nested exception is org.hibernate.exception.ConstraintViolationException: could not execute statement";
				   			$.ajax({
		   						"url" : "/academicactivity/saveSettlementOfficerRemarks",
		   						"method" : "POST",
		   						 data : formData,
		   						 success : function(data) {
		 ...
		 $('#ProceduralcomplianceForm').unbind().bind('submit',function(event) 
				   {
				   			...
				   			var formData = $(this).serializeArray();
				   			formData.push({"name":"ac","value":settlementId});
				   		//	formData.push({"name":"checkId","value":checkListid});
					...
					success:function(data)
						...
						$.ajax({
					   		...
					   		onDataTableClick('complaingridTable',function()
					   				{
					   			//	checkListid=selectedRowFromDataTable[1];
					   				//$('#checkId").val(selectedRowFromDataTable[1]);
					   			//	$('#complDescId').val(selectedRowFromDataTable[2]);
					   			//	$('#includedId').val(selectedRowFromDataTable[3]);
					   			//	$('#proceduralRequirementDivId').modal({backdrop: 'static',keyboard: false}); 
...
<div class="card-header">
   <h3>Office Verification of Expenditure Sanction / Settlement of Advance - Details of Bills , Vouchers and utilisation of Advance</h3>
</div>
<div class="card-body">
<div class="row">
	   ...
	   <div id="tabs-2">
        <div id="officeUseDiv">
          <div class="row">
            ...
            <div class="row">
	             <p>
                 <button type="button" class="btn btn-primary" id="ascomplianceId" data-toggle="collapse" data-target="#complianceDivId">
               ...
               <div class="card card-body">
                 ...
                 <div class="row">
	              <p>
                  <button type="button" class="btn btn-primary" data-toggle="modal" id="proceduralRequirementBt" data-target="#proceduralRequirementDivId">
          ...
          <div class="form-group">
               <label for="activityLevel">Office Verification<span
                  class="required">*</span></label>
               <div style="width: 100%">
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="recommendationStatus"
                        ...
                        <option value="">Select</option>
                        <option value="OfficeRecommended">Approve</option>
                        <option value="OfficeRejected">Reject</option>
...
<div class="modal fade" id="expenditureDetailsFormId1" tabindex="-1"
   ...
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Add admissible amount
            </h5>
            <button type="button" class="close" data-dismiss="modal"
               aria-label="Close">
            <span aria-hidden="true">&times;</span>
           ...
           <form id="ProceduralcomplianceForm">
		       ...
		       <div class="form-group">
						<label for="asGrantedId">CheckList Id</label> <input
							type="text" name="checkId" class="form-control" id="checkId" 	required />
					</div>
