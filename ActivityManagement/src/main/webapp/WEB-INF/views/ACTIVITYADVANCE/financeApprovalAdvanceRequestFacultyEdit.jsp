...
function loadAllAcademicActivityTypeDetails() {
	$.ajax({
		"url" : "/academicactivity/getAllAdvanceRequestFinanciallyApproved",
		"method" : "GET",
			    			...
			    			success:function(data)
			    				...
			    				if(data)
			    					{	
                                           ...
                                           $('#commentsFinanceId').val(data['commentsFinance']);
				      ...
				      if((totalAdvanceRequestedupdated>eligbleamnt)>0)
				      {
				  	   ...
				  	   //showMessage("requested amnt exceeds your advance limit pls enter the reason in remarks field");
								...
								$('#confId').unbind().bind('click',function(){
									...
									$.ajax({
										"url" : "/academicactivity/financialApprovalAdvanceRequestEdit",
										"method" : "POST",
										 data : formData,
										 success : function(data) {
											console.log(data);
...
<div class="card card-info card-outline">
	<div class="card-header">
		<h3>Edit Financial Approval for Advance Request By Faculty</h3>
	</div>
