...
function loadAllExpenditureDetailsSubmitted() {
	$.ajax({
		"url" : "/academicactivity/loadAllExpenditureDetailsOfficeRecommended",
		"method" : "GET",
		success : function(data) {
			   			...
			   			$.ajax({
	   						...
	   						"method" : "POST",
	   						 ...
	   						 success : function(data) {
	   							...
	   							console.log("data after getting saveExpenditureDetails"+ data);
	   							 if(data==constrainError)
	   								 {
	   								 showMessage("VoucharNumer is already Exists");
	   								...
	   								$('#expenditureDetailsFormId1').trigger('reset');
	   								 }
	   						//	advanceSettlementId=data['setId'];
...
<div class="card-header">
   <h3>Administrative Approval For Expenditure Sanction / Settlement of Advance - Details of Bills , Vouchers and utilisation of Advance</h3>
</div>
<div class="card-body">
<div class="row">
