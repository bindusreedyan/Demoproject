...
function loadAllExpenditureDetailsSubmitted() {
	$.ajax({
		"url" : "/academicactivity/loadAllExpenditureDetailsFinanceOfficeApproved",
		"method" : "GET",
		success : function(data) {
		 ...
		 $('#remarkssForm').unbind().bind('submit',function(event) 
			...
			// financeOfficeApproval=$('#verifiedL1RemarksId').val();
			 ...
			 financeApproval=$('#financialRecommendationRemarkId').val();
				   			...
				   			constrainError="could not execute statement; SQL [n/a]; constraint [uk_dv7ekuwotvvykbxcwxyqas0gl]; nested exception is org.hibernate.exception.ConstraintViolationException: could not execute statement";
				   			$.ajax({
		   						"url" : "/academicactivity/saveSettlementFinancialRemarks",
		   						"method" : "POST",
		   						 data : formData,
		   						 success : function(data) {
...
<div class="card-header">
   <h3>Financial Approval For Expenditure Sanction / Settlement of Advance - Details of Bills , Vouchers and utilisation of Advance</h3>
</div>
<div class="card-body">
<div class="row">
	   ...
	   <div id="tabs-2">
        <div id="officeUseDiv">
         ...
         <div class="collapse" id="proceduralRequirementsDiv">
          ...
          <div class="form-group">
               <label for="activityLevel">Financial Office Approval<span
                  class="required">*</span></label>
               <div style="width: 100%">
                  <div style="display: inline-block; width: 100%">
                     <select class="form-control selectpicker" name="recommendationStatus"
                        ...
                        <option value="">Select</option>
                        <option value="FinanceApproved">Approve</option>
                        <option value="FinanceApproved">Reject</option>
